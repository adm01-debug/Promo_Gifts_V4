// Contrato offline do favorites-watcher.
//
...
Deno.test("favorites-watcher: o fonte verifica o erro do insert antes de incrementar users_notified", async () => {
...
Deno.test("favorites-watcher: erro retornado pelo Supabase não incrementa users_notified", async () => {
  let usersNotified = 0;
...
Deno.test("favorites-watcher: insert bem-sucedido incrementa users_notified uma vez", async () => {
  let usersNotified = 0;
