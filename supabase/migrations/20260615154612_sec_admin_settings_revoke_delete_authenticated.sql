...
-- Adicionar policy explícita de DENY documentada como comentário
-- (RLS já bloqueia implicitamente, mas deixamos registrado no COMMENT da coluna)
-- Não criamos policy de DENY no Postgres — sem policy = DENY por design com RLS.
;
