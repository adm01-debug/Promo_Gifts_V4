-- Melhoria 1+2: marcar como 'missing' as referencias nao-seq confirmadas ausentes no CF.
-- Evidencia: cf_images_batch_check (185/185 ausentes). Reversivel via action_log.
