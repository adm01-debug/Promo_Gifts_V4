...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      v_ok := v_ok + 1;
      RAISE NOTICE '[063] analytics.%: revoked SELECT (relkind=%)', r.relname, r.relkind;
    EXCEPTION WHEN OTHERS THEN
...
BEGIN
  ...
  RAISE NOTICE '[063] Validation: public_anon=%, analytics_anon=%, views_missing_securityinvoker=%',
