-- ============================================================================
-- MELHORIA #11: Expansão da P4.5 com acentos e novos sinônimos
-- Adiciona versões com acento e novas cores identificadas como gap
-- ============================================================================
...
BEGIN
  ...
  -- P4.5: Tabela de sinônimos universais inline (v2 — com acentos e expansões)
  IF v_name_norm IS NOT NULL THEN
    ...
    FROM (VALUES
      ...
      ('ROSE GOLD',       'd9dc29020-e932-4a2a-bdc6-d13ddf5e31a5'::uuid),
      -- ── Hífen → sem hífen ────────────────────────────────────────────────────
      ...
      ('CAFÉ',            '096c51ff-8dbd-402d-88c1-5ca83e856354'::uuid),
      ('CAFÉ ESCURO',     'ad35ed9b-9c05-4f1c-a922-a96c73c275d3'::uuid),
