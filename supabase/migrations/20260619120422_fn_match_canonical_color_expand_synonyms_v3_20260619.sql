-- ============================================================================
-- MELHORIA #11 v3: Corrige UUID do Rose Gold e expande sinônimos com acentos
-- ============================================================================
...
BEGIN
  ...
  -- P4.5: Tabela de sinônimos universais inline (v3 final)
  -- 85+ entradas: inglês, hífen, sem acento, com acento, variações de fornecedores
  IF v_name_norm IS NOT NULL THEN
    ...
    FROM (VALUES
      ...
      -- Com acento (v2 — cobre acentos que a P1 não encontra)
