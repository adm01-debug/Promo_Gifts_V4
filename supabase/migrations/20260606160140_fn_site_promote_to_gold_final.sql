...
BEGIN
  ...
  -- (f) NOVO: product_properties — cores, gravação, vídeo (URLs), galeria (URLs)
  --     Nota: product_images e product_videos exigem cloudflare_*_id NOT NULL
  --     → dados ficam aqui até o worker Cloudflare processar e promover
  INSERT INTO public.product_properties (product_id, property_code, property_value, source, raw_value)
  ...
  -- (g) NOVO: xbz_gallery_staging — enfileira imagens para worker Cloudflare
