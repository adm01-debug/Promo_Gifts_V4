...
-- ============================================================================
-- Patch E1: corrigir gap_color_id na matview (applies_to_color=true, não is_color_specific)
-- ============================================================================
...
SELECT
  ...
  -- CORRIGIDO: applies_to_color (boolean) não is_color_specific da FK
...
'Auditoria completa de product_images: 7 dimensões de qualidade, score 0-100, gap flags, prioridade_correcao. Refresh a cada 6h via pg_cron (job refresh-mv-product-images-audit). Não exposto a anon/authenticated.';
;
