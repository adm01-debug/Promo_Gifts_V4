...
-- ============================================================
-- BUG FIX: cria RPC restore_seller_cart
-- Lovable criou em 20260713101342, nunca foi aplicada ao banco canônico.
-- Causa do bug no console: 404 + PGRST204 no fallback com shipping_deadline.
-- ============================================================
...
-- ACL: nunca conceder para anon/public
...
COMMENT ON FUNCTION public.restore_seller_cart(jsonb) IS
  'Restaura carrinho excluído (Undo) em transação atômica. '
  'Deduplica itens por (product_id, color_name) somando quantidades; '
  'ON CONFLICT DO NOTHING contra unique_cart_item_variant. '
  'Retorna jsonb {cart_id, items_total, items_inserted, items_deduped}. '
  'Criada em 20260713101342 (Lovable), aplicada ao banco em 2026-07-14.';
;
