-- =============================================================================
-- FIX: fn_capture_connection_snapshot — adicionar SET search_path = public
-- MOTIVO: SECURITY DEFINER sem SET search_path = vulnerabilidade de schema
-- injection (CVE pattern). Descoberto em auditoria adversarial 2026-06-23.
-- DRY-RUN: retornou jsonb object correto com search_path ✅
-- =============================================================================
