-- ============================================================
-- Melhoria 0: Fundacao de Reconciliacao Cloudflare x product_images
-- Schema isolado, aditivo, idempotente. Nada em public e mutado.
-- ============================================================
...
-- View: divergencias DB x CF (so util apos crawl popular cf_image)
