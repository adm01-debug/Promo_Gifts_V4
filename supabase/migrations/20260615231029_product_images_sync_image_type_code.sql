-- ============================================================================
-- product_images :: coerência image_type (texto) <-> image_type_id (FK)
...
-- Drift atual medido = 0; guard é preventivo. Dispara só quando image_type_id muda.
-- ============================================================================
...
BEGIN
  IF NEW.image_type_id IS NOT NULL THEN
    ...
    -- só sobrescreve se a FK resolve para um code válido
