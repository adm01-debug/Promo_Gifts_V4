...
-- MELHORIA 1 · PASSO 5a — Recriar v_products_public
-- Colunas mortas servidas como NULL/false para manter contrato de API (TypeScript types inalterados)
...
-- Restaurar grants (contrato PostgREST)
