-- ============================================================================
-- Ajuste de documentação (review CodeRabbit): o COMMENT de fn_sync_image_type_code
-- ficou desatualizado após a migration ..._close_drift expandir o trigger para
-- disparar também em UPDATE OF image_type. Reescreve o COMMENT refletindo ambos.
-- ============================================================================
