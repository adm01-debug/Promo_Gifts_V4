...
-- BUG-ALERT-1 FIX (2026-06-23): v_system_alerts CRON_FAIL_RECENT falso positivo
-- Threshold HAVING count(*)>0 disparava CRITICAL para qualquer falha transitória
-- (ex: "job startup timeout" do pg_cron scheduler). Fix: critério duplo.
