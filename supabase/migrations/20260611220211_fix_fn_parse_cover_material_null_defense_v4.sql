...
-- FIX: Defender contra JSON null ('null'::jsonb) e jsonb não-array
...
BEGIN
  ...
  -- Defender contra SQL NULL, JSON null, e tipos não-array
  ...
  -- ── PRIORIDADE 3: Descrição (somente contexto de capa) ────────
