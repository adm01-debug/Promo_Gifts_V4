...
-- fn_promote_padronizacao: limpar process_errors ao marcar o raw como processed.
-- A CHECK chk_spr_no_processed_with_errors proibe status='processed' com
-- process_errors preenchido. A versao anterior nao limpava process_errors,
-- causando violacao de constraint em raws que haviam falhado antes.
...
BEGIN
  ...
  -- process_errors=NULL obrigatorio: CHECK chk_spr_no_processed_with_errors
  -- proibe status='processed' com process_errors preenchido.
