...
DROP INDEX IF EXISTS public.idx_stock_snapshots_supplier_branch_id;
DROP INDEX IF EXISTS public.idx_mv_pia_score;
DROP INDEX IF EXISTS public.idx_stock_daily_summary_supplier_branch_id;
DROP INDEX IF EXISTS public.idx_mv_pia_supplier_prioridade;

-- ─── Tier 2: Medium indexes 100 KB – 1 MB ───────────────────────────────────
DROP INDEX IF EXISTS public.idx_mv_pia_product_pendente;
DROP INDEX IF EXISTS public.idx_mv_product_images_audit_prioridade;
DROP INDEX IF EXISTS public.idx_mv_pia_gaps_format_dim;
...
DROP INDEX IF EXISTS public.idx_kit_comp_enrichment_raw_promoted_padronizacao;
DROP INDEX IF EXISTS public.idx_kit_comp_padronizacao_raw_id;
DROP INDEX IF EXISTS public.idx_kit_comp_enrichment_raw_promoted_component;
DROP INDEX IF EXISTS public.idx_quotes_client_name_trgm;
DROP INDEX IF EXISTS public.idx_quotes_quote_number_trgm;
DROP INDEX IF EXISTS public.idx_workspace_notifications_search_vector;
DROP INDEX IF EXISTS public.idx_product_kit_components_padronizacao_id;
DROP INDEX IF EXISTS public.idx_produtos_site_padronizacao_raw_id;
DROP INDEX IF EXISTS public.idx_product_fiscal_ncm_id;
DROP INDEX IF EXISTS public.idx_produtos_padronizacao_sub_brand_id;
DROP INDEX IF EXISTS public.idx_fk_kit_component_enrichment_raw_imported_by;
DROP INDEX IF EXISTS public.idx_fk_kit_component_padronizacao_reviewed_by;
DROP INDEX IF EXISTS public.idx_kit_comp_padronizacao_component_type_code;
DROP INDEX IF EXISTS public.idx_kit_comp_padronizacao_pkg_type_code;
DROP INDEX IF EXISTS public.idx_prod_similarity_grp_members_supplier_id;
DROP INDEX IF EXISTS public.idx_kit_comp_variant_skus_item_color_id;
DROP INDEX IF EXISTS public.idx_catalog_analytics_user_id;
DROP INDEX IF EXISTS public.idx_fk_included_packaging_techniques_technique_id;
DROP INDEX IF EXISTS public.idx_fk_product_deactivation_requests_approved_by;
DROP INDEX IF EXISTS public.idx_fk_product_deactivation_requests_rejected_by;
DROP INDEX IF EXISTS public.idx_fk_product_deactivation_requests_requested_by;
DROP INDEX IF EXISTS public.idx_fk_product_deactivation_requests_supplier_id;
DROP INDEX IF EXISTS public.idx_fk_product_deactivation_tokens_request_id;
DROP INDEX IF EXISTS public.idx_fk_product_packagings_packaging_id;
DROP INDEX IF EXISTS public.idx_product_novelties_created_by;
DROP INDEX IF EXISTS public.idx_pbd_placements_gin;
...
BEGIN
  ...
  RAISE NOTICE '✓ Migration 036 complete — unused indexes dropped (~60 MB reclaimed)';
