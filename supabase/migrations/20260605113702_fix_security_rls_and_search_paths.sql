...
-- RLS on produtos_padronizacao_variantes
...
-- Fix mutable search_path — fn_log_price_change
...
-- Fix mutable search_path — fn_safe_int
...
-- Fix mutable search_path — fn_safe_num
...
-- Fix mutable search_path — fn_derive_parent_ref
...
-- Fix mutable search_path — fn_extract_color_from_title
