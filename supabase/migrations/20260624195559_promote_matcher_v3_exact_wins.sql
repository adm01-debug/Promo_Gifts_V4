...
BEGIN
  ...
  LOOP
    ...
    ELSE
      ...
      -- exato (>=0.999) vence sempre; nao-exato exige ausencia de empate e >=0.50
      IF v_conf IS NULL OR v_conf < 0.50 OR (v_conf < 0.999 AND v_tie > 0) THEN v_comp:=NULL; END IF;
    END IF;
