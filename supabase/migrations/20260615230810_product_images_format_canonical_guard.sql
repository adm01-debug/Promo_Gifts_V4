-- ============================================================================
-- product_images :: blindagem do campo `format`
-- Mantém o domínio canônico (lowercase, jpg->jpeg) no momento da escrita e
-- garante o INVARIANTE de minúsculo via CHECK — sem enumerar formatos, para
-- não quebrar formatos válidos futuros (avif, jxl) nem o job de ingestão vivo.
-- ============================================================================
