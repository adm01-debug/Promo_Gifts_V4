...
-- Fix M4-b: quando main_category_id IS NULL, leaf é sempre seguro
-- (sem main para comparar → sem risco de hierarquia errada)
...
-- Recriar v_products_public (dropped by CASCADE)
