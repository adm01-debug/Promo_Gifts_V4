-- =============================================================================
-- FIX: fn_cron_safe_run — adicionar SET search_path = public
...
-- EXECUTE p_sql herda o search_path da função → seguro para todos os 48 crons
-- pois nenhum referencia tabelas fora de 'public' de forma não qualificada.
-- =============================================================================
