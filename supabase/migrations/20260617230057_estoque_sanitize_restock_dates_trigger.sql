...
-- Auditoria do módulo Estoque (2026-06-17) — fix de causa-raiz para "Estoque
-- Futuro" fantasma. O cron diário fn_purge_expired_restock_dates(false) roda às
-- 06:00 e SUCEDE, mas os syncs de fornecedor (XBZ/SPOT/Asia) reinjetam datas já
-- vencidas do feed ao longo do dia (336 entradas vencidas reapareceram ~16h após
-- o purge). Trigger BEFORE leve e PURO sanitiza toda escrita, em qualquer caminho
-- de ingestão, de forma centralizada.
