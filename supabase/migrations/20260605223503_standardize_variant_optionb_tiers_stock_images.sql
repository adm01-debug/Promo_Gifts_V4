...
BEGIN
  ...
  IF r.supplier_id=v_SPOT THEN
    -- SPOT: cor por ColorCode (lookup); ColorDesc1/ColorHex1 = descritivos reais do feed.
    -- Estoque do feed Stocks (stock_data). Faixas/reposição/multiplier/imagens = Opção B.
