...
-- =============================================================================
-- FIX: 3 funções SECURITY DEFINER sem SET search_path explícito
-- =============================================================================
-- VULNERABILIDADE: funções SECURITY DEFINER sem search_path são vulneráveis
-- a schema injection — um chamador malicioso pode alterar search_path e
-- redirecionar queries para tabelas falsas. Recomendação PostgreSQL:
-- sempre usar SET search_path em SECURITY DEFINER functions.
-- =============================================================================

-- 1. fn_quotes_validate_discount (trigger de validação de desconto em quotes)
...
-- 2. fn_rebuild_color_swatches (constrói swatches de cor)
...
-- 3. notify_quote_status_change (trigger de notificação de status de orçamento)
