...
-- FIX: SECURITY DEFINER + SET search_path = public, archive (mesmo padrão de
-- get_top_collected_products e get_collections_weekly_count já corrigidas).
-- =============================================================================
...
-- Autorização via auth.uid() no corpo — SECURITY DEFINER é seguro
