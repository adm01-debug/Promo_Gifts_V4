...
| Arquivo/objeto | Agente | Branch/PR | Início (UTC) | TTL | Status |
|---|---|---|---|---|---|
| `docs/db/proposals/20260922*quote*`, `scripts/simulate-quote-rpc-proposals.mjs`, `tests/{scripts/quote-rpc-proposals.test.mjs,sql/quote-rpc-*,fixtures/quote-rpc-*}`, decisão/relatório de RPCs e plano/execução de 22/09 | Codex | `codex/quote-rpc-proposals-20260922` | 2026-09-22T20:51:34Z | 48 h | preparação e simulação autorizadas; aplicação canônica NÃO autorizada |
