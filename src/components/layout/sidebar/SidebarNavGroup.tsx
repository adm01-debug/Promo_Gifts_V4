      ...
      const linkContent = (
        <NavLink
          ...
          className={cn(
            ...
            isActive
              ? 'bg-primary/10 font-bold text-white before:absolute before:bottom-[15%] before:left-0 before:top-[15%] before:w-[3px] before:rounded-r-full before:bg-primary'
      ...
      <Collapsible open={isOpen} onOpenChange={onToggle}>
        <CollapsibleTrigger asChild>
          <button
            ...
            className={cn(
              'flex w-full items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary/20 active:scale-[0.99]',
