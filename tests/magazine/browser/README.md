...
Cobertura: A4/escopo em galeria fria; criação com template; CTA público canônico e menu; Fit em largura e altura; Ctrl+S; páginas estruturadas com institucional/contato; falha de gravação sem falso salvo. O script falha se uma asserção ou erro de página ocorrer. O caminho do JSON de resultados temporário aparece na saída.
