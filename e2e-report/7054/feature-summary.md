...
- **Run started:** 2026-09-24 17:47
- **Wall time:** 30.1s
- **Projects:** chromium-smoke
- **Totals:** 56 total · ✅ 10 · ❌ 0 · ⏭ 46
...
- `uncategorized` — flows/20-all-features-smoke.spec.ts › @smoke Funcionalidades principais (gate de CI) › 31 · Galeria de Templates de Revista
...
- `uncategorized` — flows/magazine-preview-sticky-smoke.spec.ts › @smoke Magazine Editor — preview sticky/aligned › preview alinha com hero e permanece sticky ao scrollar (xl+)
- `uncategorized` — flows/magazine-publish-smoke.spec.ts › @smoke Magazine — fluxo autenticado de publicação › publica revista e copia URL pública gerada
- `uncategorized` — flows/magazine-smoke.spec.ts › @smoke Magazine — Gold DB smoke › lista /magazine carrega do BD Gold para usuário autenticado
- `uncategorized` — flows/magazine-smoke.spec.ts › @smoke Magazine — Gold DB smoke › rota pública /revista-publica/:token consome edge magazine-public-view
