...
const MUTATIONS = [
  ...
  {
    id: 'M4',
    file: 'src/pages/magazine/components/PagesRail.tsx',
  ...
  },
  {
    id: 'M5',
    file: 'src/pages/magazine/components/PagesRail.tsx',
    find: "isActive && 'border-primary/50 bg-primary/10 ring-2 ring-primary',",
    replace: "isActive && 'border-primary/50 bg-primary/10 ring-2 ring-amber-500',",
  ...
  },
  {
    id: 'M6',
    file: 'src/pages/magazine/components/PagesRail.tsx',
    find: "'group flex w-full items-center gap-3 rounded-md border bg-card-elevated p-2 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary',",
    replace: "'group flex w-full items-center gap-3 rounded-md border bg-card-elevated p-2 text-left transition focus-visible:outline-none ring-2 ring-primary',",
